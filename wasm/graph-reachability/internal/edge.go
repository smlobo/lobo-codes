...
func (e *Edge) draw(c *fyne.Container) {
	...
	shaft := canvas.NewLine(color.RGBA{R: 40, G: 40, B: 40, A: 0xFF})
	shaft.StrokeWidth = 2
	...
	leftHead := canvas.NewLine(color.RGBA{R: 40, G: 40, B: 40, A: 0xFF})
	...
	rightHead := canvas.NewLine(color.RGBA{R: 40, G: 40, B: 40, A: 0xFF})
